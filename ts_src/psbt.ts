...
export class Psbt {
  ...
  private hasInputsWithPartialSig: boolean = false;
  ...
  private checkInputsForPartialSig(action: string): void {
  ...
  getFee(disableOutputChecks: boolean = false): bigint {
    return getTxCacheValue(
      '__FEE',
      'fee',
      this.data.inputs,
